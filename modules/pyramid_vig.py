...
class DeepGCN(torch.nn.Module):
    def __init__(self, opt):
        ...
        self.stem = Stem(out_dim=channels[0], act=act)   # (num_dims, num_H, num_W)
...
if __name__ == '__main__':
    vig = pvig_ti_224_gelu()

    from torchsummary import summary
    summary(vig, (3, 224, 224), depth=3)

    # from tensorboardX import SummaryWriter
    # with SummaryWriter(logdir="network_visualization") as w:
    #     w.add_graph(vig, torch.rand(2, 3, 224, 224).cuda())